<link rel="stylesheet" href="https://rawcdn.githack.com/mu744mu/nod/4b6e6bd5f56ddeafc51d3a3f14e90980bedc4652/bootstrap.min.css" />
<link rel="stylesheet" href="https://rawcdn.githack.com/mu744mu/nod/4b6e6bd5f56ddeafc51d3a3f14e90980bedc4652/style.css" />
<link rel="stylesheet" href="https://rawcdn.githack.com/mu744mu/nod/4b6e6bd5f56ddeafc51d3a3f14e90980bedc4652/min.css" />
...
// Requiring fs module in which
        ...
        fs.readFile('ghetto_gospel.txt', 'utf-8', (err, data) => {
            if (err) throw err;
...
<script type="8ca5c6d8-text/javascript">
...
<script type="8ca5c6d8813-text/javascript">
...
<style>
        ...
        /* .bg {
    background-color: #04374f !important;
} */
        /* Style the tab */
        /* .tab {
            overflow: hidden;
...
#micHtml {
    ...
    background-color: #4c6a8c!important;
     background-image: url(https://ta7a.net/sico/1650983882913.gif)!important; 
...
#micHtml .micSp .micModal button[datacl="muteed"],#micHtml .micSp .micModal button[datacl="mute"]{
    display: block;
}
#micHtml .micSp .micModal button[datacl="play"],#micHtml .micSp .micModal button[datacl="run"]{
    display: none;
}
#micHtml .micSp.muted .micModal button[datacl="muteed"],#micHtml .micSp.memuted .micModal button[datacl="mute"]{
    display: none!important;
}
#micHtml .micSp.muted .micModal button[datacl="play"],#micHtml .micSp.memuted .micModal button[datacl="run"]{
...
#micHtml #allMute.muted {
    background-image: url(https://ta7a.net/sico/1650986556066.png);
}
    ...
    text-align: center;
    background-image: url('https://ta7a.net/sico/1650978175009.png');
}
#micHtml #allMute {
    background: #fff;
    width: 37px;
...
#micHtml .micModal .btn {
    ...
    padding: 0!important;
        ...
        input[type=checkbox]:checked+label {
            animation: closing 0.9s forwards ease-in-out,
                moving 0.9s forwards ease-in-out;
        }
  ...
  animation: fadeIn 1s;
        ...
        @keyframes fadeIn {
            ...
            /* 200% {top: 40px; left: 0px; background: #0b6610; width: 400px;} */
            /* 70%   {top: 50px; left: 187px; background: #34495e; width: 300px;} */
            /* 50%   {top: 60px; left: 187px; background: #34495e; width: 200px;}
  40%   {top: 70px; left: 187px; background: #34495e; width: 100px;}
  30%   {top: 70px; left: 187px; background: #34495e; width: 100px;}
  20%   {top: 70px; left: 187px; background: #34495e; width: 100px;}
  10%   {top: 70px; left: 187px; background: #34495e; width: 100px;} */
            /* 0%   {top: 80px; background: #34495e; width: 100px;} */
        }
...
<style>
        ...
        .eventMic {
            -webkit-animation: mice 5s 1 linear;
            -moz-animation: mice 5s 1 linear;
            -o-animation: mice 5s 1 linear;
            animation: mice 5s 1 linear;
            -webkit-animation-fill-mode: forwards;
            -moz-animation-fill-mode: forwards;
            -o-animation-fill-mode: forwards;
            animation-fill-mode: forwards;
...
<style>
        * {
        ...
        .pmsgc {
                    background-color: rgba(0, 77, 255, 0.08)!important;
                    border: 1.3px dashed rgb(135, 168, 238);
                }
                .hmsg {
                    background-color: rgb(252 218 218)!important;
                    border: 1.3px dashed rgb(238, 160, 245);
                }
...
<style>
        * {
        ...
        .label-primary,
        .btn-primary {
            background-color: #8B8C88 !important;
        }
